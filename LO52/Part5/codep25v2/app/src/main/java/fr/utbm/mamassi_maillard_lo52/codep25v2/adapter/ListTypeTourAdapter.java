...
public class ListTypeTourAdapter extends BaseAdapter {

        public static final String TAG = "ListTypeCourseAdapter";

        private List<TypeTour> mItems;
        private LayoutInflater mInflater;
        private TypeTourDAO mDAO;
        Context mContext;

        public ListTypeTourAdapter(Context context, List<TypeTour> list) {
            this.setItems(list);
        ...
        @Override
        public TypeTour getItem(int position) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            // fill row data
            TypeTour currentItem = getItem(position);
            if(currentItem != null) {
        ...
        public List<TypeTour> getItems() {
            return mItems;
        }

        public void setItems(List<TypeTour> mItems) {
            this.mItems = mItems;
        }

        private final void showDeleteDialogConfirmation(final TypeTour clicked) {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(mContext);

            alertDialogBuilder.setTitle("Suppression");
            alertDialogBuilder.setMessage("Voulez vous supprimer le tour : "+clicked.getmTitre()+"?");
            ...
            alertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    mDAO = new TypeTourDAO(mContext);
                    if(mDAO != null) {
                        mDAO.deleteTypeTour(clicked);
