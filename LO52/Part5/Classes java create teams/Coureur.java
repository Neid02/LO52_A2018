...
public class Coureur {
    // differentes varaibles d'un coureur + add
    // add est a faux si le coureur n'a pas d'equipe
    // add est a vrai si il a une equipe
    ...
    public void setOrdrepassage_crr(int ordrepassage_crr) {
        this.ordrepassage_crr = ordrepassage_crr;
    }
